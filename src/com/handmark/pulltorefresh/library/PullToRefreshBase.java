...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	//private OnDownOrUpRefreshListener<T> mOnRefreshListener;
	private OnDownUpRefreshListener<T> mOnRefreshListener2;
	...
	/**
	 * 设置数据加载状态
	 * @param isLoading  true:为加载中，false：未加载
	 */
	public final void setDataLoadingState(boolean isLoading){
	...
	@Override
	public final void setOnRefreshListener(OnDownUpRefreshListener<T> listener) {
	...
	private void callRefreshListener() {
		if (null != mOnRefreshListener2) {
			if (mCurrentMode == Mode.PULL_FROM_START) {
				mOnRefreshListener2.onDownToRefresh(this);
			} else if (mCurrentMode == Mode.PULL_FROM_END) {
				mOnRefreshListener2.onUpToRefresh(this);
			}
		}
	}
	 ...
	 * 上下拉刷新回调
	 */
	public static interface OnDownUpRefreshListener<V extends View> {
		// TODO These methods need renaming to START/END rather than DOWN/UP

		/**
		 * 下拉刷新
		 */
		public void onDownToRefresh(final PullToRefreshBase<V> refreshView);

		/**
		 * 上拉刷新
		 */
		public void onUpToRefresh(final PullToRefreshBase<V> refreshView);
