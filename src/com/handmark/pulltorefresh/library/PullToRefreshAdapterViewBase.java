...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	public final void onScroll(final AbsListView view, final int firstVisibleItem, final int visibleItemCount,
		...
		if (!getDataLoadingState() && null != mOnLastItemVisibleListener && (totalItemCount > 0) && (firstVisibleItem + visibleItemCount == totalItemCount)) {
	...
	public final void removeOldEmptyView(View oldEmptyView){

		if (null != oldEmptyView) {

			ViewParent newEmptyViewParent = oldEmptyView.getParent();
			if (null != newEmptyViewParent && newEmptyViewParent instanceof ViewGroup) {
				((ViewGroup) newEmptyViewParent).removeView(oldEmptyView);
			}
