...
/**
 * Allows caching HTTP responses (only status code and payload at the moment)
 * using the features provided by {@link AbstractCache}. The key into the cache
 * will be the request URL used to retrieve the HTTP response in the first
 * place.
 * 
...
public class HttpResponseCache extends AbstractCache<String, ResponseData> {
	...
	public HttpResponseCache(int initialCapacity, long expirationInMinutes,
	...
	@Override
	protected void writeValueToDisk(File file, ResponseData data)
			throws IOException {
