...
public class BitmapCache {
	...
	public Bitmap getBitmapFromDiskCache(String data) {
		...
		if (SDBitmapCacheConfig.DEBUG) {
			// @author pengxh info log
			Log.d(this.getClass().getSimpleName(), "M = getBitmapFromDiskCache(String data), data = " + data
					+ ", key = " + key);
		}
		synchronized (mDiskCacheLock) {
	...
	public File getFileFromDiskCache(String url) {
		final String key = FileNameGenerator.generator(url);
		if (SDBitmapCacheConfig.DEBUG) {
			// @author pengxh info log
			Log.d(this.getClass().getSimpleName(), "M = getFileFromDiskCache(String url), data = " + url + ", key = "
					+ key);
		}

		File cFile = new File(SDBitmapCacheConfig.getAPPDiskCacheDirectory(), key + "." + DISK_CACHE_INDEX);
