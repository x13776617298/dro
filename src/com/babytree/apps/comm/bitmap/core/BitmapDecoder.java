...
public class BitmapDecoder {
    ...
    public static Bitmap decodeSampledBitmapFromAssetsFile(InputStream is,int reqWidth, int reqHeight) {
    	final BitmapFactory.Options options = new BitmapFactory.Options();
    	options.inJustDecodeBounds = true;
    	options.inPurgeable = true;
    	...
    	try {
    		...
    		Log.e(TAG, "decodeSampledBitmapFromAssetsFile内存溢出，如果频繁出现这个情况 可以尝试配置增加内存缓存大小");
    		e.printStackTrace();
    		return null;
    	}
    }
