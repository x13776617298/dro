...
public class Finalizer extends Thread {
	...
	private static final Logger logger = Logger.getLogger(Finalizer.class
			.getName());
	 ...
	 * @param frq
	 *            reference to instance of FinalizableReferenceQueue that
	 *            started this thread
	...
	private Finalizer(Class<?> finalizableReferenceClass, Object frq) {
		...
		this.finalizableReferenceClassReference = new WeakReference<Class<?>>(
		...
		try {
			...
			logger.log(Level.INFO,
					"Failed to clear thread local values inherited"
	...
	public static Field getInheritableThreadLocalsField() {
		try {
			...
			logger.log(
					Level.INFO,
					"Couldn't access Thread.inheritableThreadLocals."
